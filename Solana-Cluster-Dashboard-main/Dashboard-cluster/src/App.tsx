...
//     try {
//       const response = await fetch('http://localhost:3001.com/clusters');
//       if (!response.ok) {
...
//   const API_BASE = 'https://solana-cluster-monitor-gyw7.onrender.com';
...
//       // Optionally set error state or alert user
//     }
//   };
